...
namespace Practos3dataset.DataSet1TableAdapters {
...
SELECT AddressID, UserID, OrderID, AddressLine, City, PostalCode FROM Addresses WHERE (AddressID = @AddressID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Practos3dataset.Properties.Settings.Default.Practos_databaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"select Addresses.AddressID, Addresses.UserID, Users.UserName, Users.Email, Orders.OrderID, Orders.OrderDate, Orders.TotalAmount, Addresses.AddressLine,
Addresses.City, Addresses.PostalCode 
from Addresses 
inner join Users on Addresses.UserID = Users.UserID
inner join Orders on Addresses.OrderID = Orders.OrderID";
        ...
        public virtual DataSet1.AddressesDataTable GetDataBy() {
